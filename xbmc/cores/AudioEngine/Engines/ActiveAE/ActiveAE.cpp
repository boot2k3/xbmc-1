...
void CActiveAE::LoadSettings()
{
  ...
  m_settings.silenceTimeout = settings->GetInt(CSettings::SETTING_AUDIOOUTPUT_STREAMSILENCE) ? settings->GetInt(CSettings::SETTING_AUDIOOUTPUT_STREAMSILENCE) * 60000 : 1000;
}
